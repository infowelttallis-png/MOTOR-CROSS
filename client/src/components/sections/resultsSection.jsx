...
const GridTemplate = styled.div`
  display: grid;
  grid-template-columns: 80px 120px 80px 200px 10px; /* Reduced efficiency column width */
  column-gap: 15px;
  min-width: 650px; /* Reduced min-width */
  align-items: center;
  padding: 10px 20px;
`;
...
const TableRow = styled(GridTemplate)`
  ...
  animation: ${fadeIn} 0.2s ease forwards; /* Faster animation */
  animation-delay: ${(props) => props.$index * 0.02}s; /* Reduced delay */
  opacity: 0;
  background: ${(props) =>
...
const ProgressBarContainer = styled.div`
  width: 100%;
  max-width: 160px; /* Fixed maximum width for uniformity */
...
const Fill = styled.div`
  ...
  transition: width 0.6s cubic-bezier(0.17, 0.67, 0.83, 0.67); /* Faster transition */
